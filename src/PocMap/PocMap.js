...
let SearchedVetList = [];
class PocMap extends React.Component {
  constructor(props) {
    super(props);
    this.marker = [];
    (this.mapView = null),
      ...
      try {
        const granted = await PermissionsAndroid.request(
          PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
          {
            ...
            message:
              "Nous avons besoin d'une autorisation de localisation pour obtenir l'emplacement de l'appareil" +
              "Veuillez nous l'accorder.",
          },
        );
